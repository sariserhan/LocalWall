...
- Name: mobile-smoke.spec.ts >> Mobile smoke >> renders /sign-in without horizontal overflow
...
- main [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e4]: SIGN IN
    - paragraph [ref=e5]: Notice · LocalWall access
    - heading "Sign in to LocalWall." [level=1] [ref=e6]
    - paragraph [ref=e7]: Use your LocalWall account to post, manage, and track your listings on the wall.
    - link "Back to wall" [ref=e9] [cursor=pointer]:
      - /url: /
    - paragraph [ref=e10]:
      - text: Don't have an account yet?
      - link "Sign up" [ref=e11] [cursor=pointer]:
        - /url: /sign-up
    - generic [ref=e12]: LocalWallyour local bulletin board
  - paragraph [ref=e13]: WALL
```
