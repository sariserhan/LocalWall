...
## Corpus Check
- 229 files · ~443,629 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1524 nodes · 2217 edges · 114 communities (101 shown, 13 thin omitted)
...
Cohesion: 0.15
Nodes (10): pushDashboardHandler(), seedCards, Composer, defaultSeedLocation, DetailPanel, OwnerDashboard, PlacementMode, CardStyle (+2 more)
...
## Knowledge Gaps
- **846 isolated node(s):** `npx`, `Props`, `Props`, `Props`, `Props` (+841 more)
...
- **Why does `WallCard` connect `Community 81` to `Community 64`, `Billing, Admin & Test Infrastructure`, `Community 3`, `Community 7`, `Community 72`, `Community 108`, `Community 46`, `Community 23`?**
