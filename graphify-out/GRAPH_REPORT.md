...
## Corpus Check
- 219 files · ~437,603 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1461 nodes · 2057 edges · 106 communities (93 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `880b90e6`
...
Cohesion: 0.08
Nodes (28): metadata, bundleCard, bundleCities, crons, adminEnv, adminIdentity, applyEnv(), makeT() (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (20): seedCards, cardFormats, WallCard, Composer, defaultSeedLocation, DetailPanel, OwnerDashboard, PlacementMode (+12 more)
...
Cohesion: 0.06
Nodes (32): metadata, Props, AppProviders(), AppProvidersProps, BugReportLink(), ContactLink(), GlobalBugReportModal(), GlobalContactModal() (+24 more)
...
Cohesion: 0.05
Nodes (38): approveVerification, blockUser, configuredAdminEmails(), deleteAllCardsByOwner, deleteCardsByOwnerBatch, getAccess, getAdminIdentity(), getAuditLog (+30 more)
...
Cohesion: 0.09
Nodes (22): recordLogin, reportBug, sendContactMessage, http, quotas, scopeValidator, take, getMyReview (+14 more)
...
Cohesion: 0.15
Nodes (19): HomeNav(), actionBtn, barlowUpper, font, getClerkUserButtonAppearance(), getClerkUserProfileAppearance(), iconBox, profileAppearance() (+11 more)
...
Cohesion: 0.20
Nodes (14): OwnerDashboard, themeLabels, OwnerDashboardProps, renewalOptions, CardTheme, cardThemes, CardUpdate, categories (+6 more)
...
Cohesion: 0.25
Nodes (7): deleteCardOwnedData(), deleteAccount, _deleteMyData, exportMyData, _gatherMyData, GdprExport, internalMutation
...
## Knowledge Gaps
- **820 isolated node(s):** `metadata`, `PG_LOCATION`, `getAccess`, `getDashboard`, `playgroundStoreImageFromUrl` (+815 more)
...
- **Why does `api` connect `Geo-Routed Pages & RSS Feeds` to `Community 32`, `Billing, Admin & Test Infrastructure`, `Community 34`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 17`, `Community 23`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `captureAnalytics()` connect `Community 9` to `Community 17`, `Community 3`, `Community 23`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `WallCard` connect `Community 3` to `Community 32`, `Billing, Admin & Test Infrastructure`, `Community 7`, `Community 17`, `Community 23`?**
...
- **What connects `metadata`, `PG_LOCATION`, `getAccess` to the rest of the system?**
