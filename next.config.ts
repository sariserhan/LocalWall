...
const scriptSrc = isDev
  ? "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.com https://*.clerk.accounts.dev https://clerk.localwall.app https://challenges.cloudflare.com"
  : "script-src 'self' 'unsafe-inline' https://clerk.com https://*.clerk.accounts.dev https://clerk.localwall.app https://challenges.cloudflare.com";
...
const CSP = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://*.convex.cloud wss://*.convex.cloud https://clerk.com https://*.clerk.accounts.dev https://clerk.localwall.app https://*.sentry.io https://api.open-meteo.com",
  "frame-src https://challenges.cloudflare.com https://clerk.com https://*.clerk.accounts.dev https://clerk.localwall.app",
