    ...
    <AppProviders clerkPublishableKey={clerkPublishableKey}>
      <main className="nf-page sign-in-page">
        ...
        <div className="nf-card sign-in-card">
          ...
          <h1 className="nf-headline">Sign in to LocalWall.</h1>
          <p className="nf-body">
            Use your LocalWall account to post, manage, and track your listings on the wall.
          </p>

          <div className="sign-in-panel">
            <SignIn appearance={signInAppearance} signUpUrl="/sign-up" withSignUp />
